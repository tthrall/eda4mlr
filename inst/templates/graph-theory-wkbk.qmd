...
Extract features for each node that could be used in a machine learning model:
...
If your network is bipartite (two types of nodes), project it onto a single-mode network. Interpret the resulting edge weights.
...
Describe the difference between using graph analysis to:
