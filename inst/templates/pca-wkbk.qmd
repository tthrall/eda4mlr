...
### Task 2.2: PCA via Eigendecomposition
...
Reconstruct the original data using only the first k principal components. Compute the reconstruction error for k = 1, 2, ..., p.
