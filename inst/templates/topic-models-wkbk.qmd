...
- `gutenbergr::gutenberg_download()` — multiple books on different subjects
...
A colleague fits a 100-topic model and reports high held-out likelihood. But when you examine the topics, many are uninterpretable or redundant. How would you advise them?
