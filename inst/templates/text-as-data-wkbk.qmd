...
1. Explain why text analysis requires converting documents into numerical representations.
2. Apply preprocessing steps: tokenization, stop word removal, and stemming/lemmatization.
3. Construct a document-term matrix (DTM) from a collection of documents.
