...
- `janeaustenr::austen_books()` — 6 novels by Jane Austen (use chapters as documents)
- `gutenbergr::gutenberg_download()` — public domain books from Project Gutenberg
- Your own collection of articles, emails, or reviews
...
*How many total tokens? How many unique tokens (types)?*
...
*Why is TF-IDF often more useful than raw counts for distinguishing documents?*
