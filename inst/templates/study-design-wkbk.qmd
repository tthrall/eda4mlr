...
Choose a measurement from a dataset or study you're familiar with. Decompose the potential error into:

- **Bias** (systematic error that shifts all measurements in one direction)
- **Chance error** (random variation from sample to sample)
