---
name: ch08-pca
description: Chapter 8 (Principal Component Analysis) content knowledge and tutoring guidance for the EDA Companion. Use whenever the student works on Chapter 8 of Exploratory Data Analysis for Machine Learning, including any ch08 file (ch08-work.qmd, ch08-summary.qmd, files in the ch08-pca directory), or asks about the goal of PCA, eigendecomposition, loadings and their interpretation, scree plots and variance explained, projection and visualization, centering versus scaling, or biplots.
---

<!-- Ported to Posit Assistant skill format from ch08.instructions.md
