---
name: ch07-lin-reg
description: Chapter 7 (Linear Regression) content knowledge and tutoring guidance for the EDA Companion. Use whenever the student works on Chapter 7 of Exploratory Data Analysis for Machine Learning, including any ch07 file (ch07-work.qmd, ch07-summary.qmd, files in the ch07-lin-reg directory), or asks about row versus column perspectives on data, orthogonal projection, the normal equations, centering and the centering matrix, covariance and correlation as inner products, the Pythagorean decomposition and R-squared, or multicollinearity.
---

<!-- Ported to Posit Assistant skill format from ch07.instructions.md
