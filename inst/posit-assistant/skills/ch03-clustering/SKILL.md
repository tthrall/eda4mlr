---
name: ch03-clustering
description: Chapter 3 (Clustering: EDA in Higher Dimensions) content knowledge and tutoring guidance for the EDA Companion. Use whenever the student works on Chapter 3 of Exploratory Data Analysis for Machine Learning, including any ch03 file (ch03-work.qmd, ch03-summary.qmd, files in the ch03-clustering directory), or asks about standardizing before clustering, grouping variables versus algorithmic clustering, the k-means algorithm, the elbow method, cluster profiling, evaluating clustering with WCSS and Jaccard similarity, distance measures, or DBSCAN.
---

<!-- Ported to Posit Assistant skill format from ch03.instructions.md
