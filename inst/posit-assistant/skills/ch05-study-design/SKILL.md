---
name: ch05-study-design
description: Chapter 5 (Sampling and Study Design) content knowledge and tutoring guidance for the EDA Companion. Use whenever the student works on Chapter 5 of Exploratory Data Analysis for Machine Learning, including any ch05 file (ch05-work.qmd, ch05-summary.qmd, files in the ch05-study-design directory), or asks about sampling and study design, the 1936 Literary Digest poll, Truman versus Dewey in 1948, the Salk vaccine trial, the portacaval shunt, repeated weighing of NB10, the standard error of the sample mean, or analyst degrees of freedom.
---

<!-- Ported to Posit Assistant skill format from ch05.instructions.md
