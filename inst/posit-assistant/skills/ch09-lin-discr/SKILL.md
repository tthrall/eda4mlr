---
name: ch09-lin-discr
description: Chapter 9 (Linear Discriminant Analysis) content knowledge and tutoring guidance for the EDA Companion. Use whenever the student works on Chapter 9 of Exploratory Data Analysis for Machine Learning, including any ch09 file (ch09-work.qmd, ch09-summary.qmd, files in the ch09-lin-discr directory), or asks about supervised versus unsupervised dimension reduction, LDA versus PCA objectives, Fisher's criterion, LDA and logistic regression, applying LDA in R, confusion matrices, or LDA versus QDA.
---

<!-- Ported to Posit Assistant skill format from ch09.instructions.md
