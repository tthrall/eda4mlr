---
name: ch12-ts-data
description: Chapter 12 (Time Series Data) content knowledge and tutoring guidance for the EDA Companion. Use whenever the student works on Chapter 12 of Exploratory Data Analysis for Machine Learning, including any ch12 file (ch12-work.qmd, ch12-summary.qmd, files in the ch12-ts-data directory), or asks about independence violation in time series, the ACF and PACF, stationarity and differencing, white noise, time-domain versus frequency-domain perspectives, the spectrum, the back-shift operator, or effective sample size.
---

<!-- Ported to Posit Assistant skill format from ch12.instructions.md
