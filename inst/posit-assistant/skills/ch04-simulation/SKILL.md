---
name: ch04-simulation
description: Chapter 4 (Statistical Simulation) content knowledge and tutoring guidance for the EDA Companion. Use whenever the student works on Chapter 4 of Exploratory Data Analysis for Machine Learning, including any ch04 file (ch04-work.qmd, ch04-summary.qmd, files in the ch04-simulation directory), or asks about R's d/p/q/r function convention, generating random samples, mean versus median by simulation, Monte Carlo simulation, importance sampling, bootstrap resampling, an MCMC preview, or the machine-learning connections of simulation.
---

<!-- Ported to Posit Assistant skill format from ch04.instructions.md
