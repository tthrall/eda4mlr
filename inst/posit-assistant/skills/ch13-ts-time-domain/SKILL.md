---
name: ch13-ts-time-domain
description: Chapter 13 (Time Domain Methods) content knowledge and tutoring guidance for the EDA Companion. Use whenever the student works on Chapter 13 of Exploratory Data Analysis for Machine Learning, including any ch13 file (ch13-work.qmd, ch13-summary.qmd, files in the ch13-ts-time-domain directory), or asks about AR and MA processes and their ACF/PACF signatures, ARIMA and SARIMA models, differencing, the Box-Jenkins workflow, forecasting and prediction intervals, residual diagnostics and the Ljung-Box test, AIC and BIC, or exponential smoothing.
---

<!-- Ported to Posit Assistant skill format from ch13.instructions.md
