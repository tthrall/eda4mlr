---
name: ch11-topic-models
description: Chapter 11 (Topic Models) content knowledge and tutoring guidance for the EDA Companion. Use whenever the student works on Chapter 11 of Exploratory Data Analysis for Machine Learning, including any ch11 file (ch11-work.qmd, ch11-summary.qmd, files in the ch11-topic-models directory), or asks about the LDA generative model, the beta and gamma matrices, fitting LDA in R, choosing the number of topics K, evaluating topic quality, the two LDAs, or the Dirichlet distribution.
---

<!-- Ported to Posit Assistant skill format from ch11.instructions.md
