---
name: ch14-ts-freq-domain
description: Chapter 14 (Frequency Domain Methods) content knowledge and tutoring guidance for the EDA Companion. Use whenever the student works on Chapter 14 of Exploratory Data Analysis for Machine Learning, including any ch14 file (ch14-work.qmd, ch14-summary.qmd, files in the ch14-ts-freq-domain directory), or asks about the spectrum as a variance decomposition, the periodogram, spectral smoothing and the bandwidth trade-off, reading spectral peaks and harmonics, cross-spectrum and coherence, or ARMA spectra.
---

<!-- Ported to Posit Assistant skill format from ch14.instructions.md
