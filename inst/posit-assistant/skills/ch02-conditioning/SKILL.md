---
name: ch02-conditioning
description: Chapter 2 (Conditional Distributions) content knowledge and tutoring guidance for the EDA Companion. Use whenever the student works on Chapter 2 of Exploratory Data Analysis for Machine Learning, including any ch02 file (ch02-work.qmd, ch02-summary.qmd, files in the ch02-conditioning directory), or asks about conditional expectation, the graph of averages, z-scores and standardization, the SD line versus the regression line, the correlation coefficient, correlation versus causation and independence, regression to the mean, the Anscombe quartet, the chi-squared test, or Simpson's paradox.
---

<!-- Ported to Posit Assistant skill format from ch02.instructions.md
