---
name: ch10-text-as-data
description: Chapter 10 (Text as Data) content knowledge and tutoring guidance for the EDA Companion. Use whenever the student works on Chapter 10 of Exploratory Data Analysis for Machine Learning, including any ch10 file (ch10-work.qmd, ch10-summary.qmd, files in the ch10-text-as-data directory), or asks about converting text to numbers, the preprocessing pipeline, the document-term matrix, tf-idf, bag of words versus embeddings, or the generative story for LDA.
---

<!-- Ported to Posit Assistant skill format from ch10.instructions.md
