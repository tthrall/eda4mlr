---
name: ch15-graph-theory
description: Chapter 15 (Graph Theory for Machine Learning) content knowledge and tutoring guidance for the EDA Companion. Use whenever the student works on Chapter 15 of Exploratory Data Analysis for Machine Learning, including any ch15 file (ch15-work.qmd, ch15-summary.qmd, files in the ch15-graph-theory directory), or asks about nodes and edges, adjacency and Laplacian matrices, centrality measures such as degree, betweenness, closeness, and PageRank, community detection and modularity, spectral clustering, graph features for machine learning, or bipartite graphs and collaborative filtering.
---

<!-- Ported to Posit Assistant skill format from ch15.instructions.md
...
| Directed graph         | Edges have direction (from → to)                                         |
