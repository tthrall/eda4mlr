---
name: ch06-info-theory
description: Chapter 6 (Information Theory) content knowledge and tutoring guidance for the EDA Companion. Use whenever the student works on Chapter 6 of Exploratory Data Analysis for Machine Learning, including any ch06 file (ch06-work.qmd, ch06-summary.qmd, files in the ch06-info-theory directory), or asks about entropy, joint entropy and independence, mutual information, KL divergence, cross-entropy, or their machine-learning connections.
---

<!-- Ported to Posit Assistant skill format from ch06.instructions.md
