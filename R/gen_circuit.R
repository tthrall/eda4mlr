...
#'
#' @param f_0 <dbl> positive constant
#' @param f_1 <dbl> amplitude (f_1 < f_0)
#' @param period <dbl> period of the sine wave
#' @param phase <dbl> phase of the sine wave (mod 1)
#'
#' @return sine wave function f(t) > 0
#' @export
...
#'
#' @param n_pts <int> desired number of points
#' @param f_0 <dbl> positive constant
#' @param f_1 <dbl> amplitude (f_1 < f_0)
#' @param period <dbl> period of the sine wave
#' @param phase <dbl> phase of the sine wave (mod 1)
#'
#' @return point pairs along simple closed curve
#' @export
