...
#' @param grp_name <chr> name of grouping variable
#'
#' @return within-group list: mean-deviation per var, deviation-norm
#' @export
pt_ctr_dist <- function(
  ...
  grp_norms <- grp_dev_mat |>
    ...
    dplyr::mutate(gp_tmp = grp_deviations |> dplyr::pull(var = grp_name)) |>
