...
###
#     get_ref_materials.R
#       -- list reference materials via separate modules
###
#####

#' -- reformat reference tibble as [title](link) by auth
#'
#' @param x <tbl> tibble containing (title, link, auth)
#' @param t_idx <int> index of column containing title
#' @param l_idx <int> index of column containing link
#' @param a_idx <int> index of column containing author
#'
#' @return tibble reformatted as [title](link) by auth
#' @export
list_links <- function(
...
#'
#' @return tibble of reference articles
#' @export
get_articles_tbl <- function() {
  articles_tbl <- tibble::tribble(
    ...
    "Fun with asta", "https://github.com/nickpoison/astsa/tree/master/fun_with_astsa"
  )
  return(articles_tbl)
}

#' -- return a tibble of reference books
#'
#' @return tibble of reference books
#' @export
...
#'
#' @return tibble of technical symbols
#' @export
